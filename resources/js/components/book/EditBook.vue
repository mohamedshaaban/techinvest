    ...
    <div  id="content" class="site-content home-v3 page-template-template-homepage-v3 woocommerce-active" tabindex="-1">
        ...
        <form class="checkout woocommerce-checkout">
            ...
            <p class="form-row form-row-wide text-center validate-required" >
                <input name="id" type="hidden" v-model="book.id">
                <button class="button alt place-order " @click.prevent="updateBook">Update Book</button>
            </p>
        </form>
...
export default {
    ...
    mounted() {
        ...
        axios.get('/api/v1/book/details/'+this.id
