    ...
    <div  id="content" class="site-content home-v3 page-template-template-homepage-v3 woocommerce-active" tabindex="-1">
        ...
        <form class="checkout woocommerce-checkout">
            <p class="form-row form-row-first validate-required" id="billing_addresse_name">
                ...
                <input type="text" class="input-text form-control"  required name="customer_name" id="customer_name" v-model="invoice.customer_name" />
            </p>

            <p class="form-row form-row-first validate-required" id="billing_addresse_name">
                <label for="customer_number" class="control-label">customer number</label>
                <input type="text" class="input-text form-control"  required name="customer_number" id="customer_number" v-model="invoice.customer_number" />
            </p>

            <p class="form-row form-row-first validate-required" id="billing_addresse_name">
                <label for="customer_address" class="control-label">customer address</label>
                <input type="text" class="input-text form-control"  required name="customer_address" id="customer_address" v-model="invoice.customer_address" />
            </p>

            <p class="form-row form-row-first validate-required" id="billing_addresse_name">
                <label for="invoice_number" class="control-label">invoice number</label>
                <input type="text" class="input-text form-control"  required name="invoice_number" id="invoice_number" v-model="invoice.invoice_number" />
            </p>
            <p class="form-row form-row-first validate-required" id="billing_addresse_name">
                <label for="invoice_date" class="control-label">invoice date</label>
                <input type="date" class="input-text form-control"  required name="invoice_date" id="invoice_date" v-model="invoice.invoice_date" />
            </p>
            <p class="form-row form-row-first validate-required" id="billing_addresse_name">
                <label for="book_id" class="control-label">book</label>
                <select class="input-text form-control"  required name="book_id" id="book_id" v-model="invoice.book_id" >
            ...
            <p class="form-row form-row-wide text-center validate-required" >
                <button class="button alt place-order " @click.prevent="updateInvoice">save Invoice</button>
            </p>
        </form>
